...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 12 19:29:19 2023
...
HI = User("high income",7)
User_list.append(HI)

LI = User("low income",38)
User_list.append(LI)
...
HC_printer = HC.Appliance(HC,2,100,1,60,0.3,10,occasional_use=0.3)
...
HC_water_pump = HC.Appliance(HC,1,400,1,30,0.2,10, occasional_use=0.5)
...
HC_shower = HC.Appliance(HC,1,3000,2,120,0,1,15, occasional_use=0.3)
HC_shower.windows([360,720],[780,1020],0.35)
