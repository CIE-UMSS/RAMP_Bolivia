...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 10 12:41:18 2023
...
HI = User("high income",28)
User_list.append(HI)

LI = User("low income",153)
User_list.append(LI)
...
HC_water_pump = HC.Appliance(HC,1,400,1,30,0.2,10, occasional_use=0.3)
HC_water_pump.windows([480,510],0.35)
