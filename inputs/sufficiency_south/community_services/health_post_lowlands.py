...
HC_indoor_bulb.windows([0,720],[870,1440],0.35)

HC_outdoor_bulb = HC.Appliance(5,13,2,240,0.2,10)
HC_outdoor_bulb.windows([0,342],[1037,1440],0.35)

HC_Phone_charger = HC.Appliance(5,5,2,300,0.2,5)
HC_Phone_charger.windows([480,720],[900,1440],0.35)

HC_TV = HC.Appliance(2,60,2,360,0.1,30)
HC_TV.windows([480,720],[780,1020],0.2)

HC_radio = HC.Appliance(2,35,2,360,0.2,60)
HC_radio.windows([480,720],[780,1020],0.35)

HC_PC = HC.Appliance(2,150,2,300,0.1,10)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'health_center_MOZ.csv')
