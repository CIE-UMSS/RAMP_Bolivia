...
Health Center in a community from the highlands
'''
...
H_shower_P = pd.read_csv('shower_P_HL_of.csv')
...
HC_heater = HC.Appliance(2,800,1,120,0.1,10, occasional_use = 0.3)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'health_center_BO_HL.csv')
