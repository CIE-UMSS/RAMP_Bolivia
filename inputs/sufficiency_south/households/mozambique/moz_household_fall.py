...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  6 10:08:42 2024

@author: claudia

Household from Mozambique with SUFFICIENCY REQUIREMENTS
FALL
"""
import pandas as pd
...
H_Air_Conditioner = H.Appliance(1,900,1,240,0.27,30, occasional_use=0.33)
H_Air_Conditioner.windows([600,980],[0,0],0.35)
'''
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_moz_fall_lightinh_trad.csv')