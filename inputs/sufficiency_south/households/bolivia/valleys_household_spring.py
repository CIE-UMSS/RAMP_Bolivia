...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  6 12:01:44 2024
...
#H_Fan = H.Appliance(2,30,1,120,0.27,60, occasional_use=0.33)
#H_Fan.windows([780,1080],[0,0],0.35)
...
#Hygiene
H_shower = H.Appliance(1,H_shower_P,2,25,0.1,3, thermal_P_var = 0.3)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_BO_V_spring_lighting_trad.csv')