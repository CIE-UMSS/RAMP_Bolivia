...
# #Hygiene
# #H_shower = H.AppHiance(1,H_shower_P,2,30,0.1,3, thermaH_P_var = 0.3)
...
#H_Fan = H.Appliance(1,30,1,180,0.27,60, occasional_use=0.33)
#H_Fan.windows([720,1080],[0,0],0.35)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_BO_V_summer_lighting_trad.csv')