...
#Thermal 
# H_heater = H.Appliance(2,800,2,120,0.1,10, occasional_use = 0.33)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_BO_HL_summer_lighting_trad.csv')
