...
# #thermal comfort
# #H_Fan = H.Appliance(4,30,2,120,0.27,30)
...
# H_shower.windows([360,540],[1080,1260],0.2) #Use thermal series from kny
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_kny_winter_lighting_trad.csv')