...
Household from the Kenya with SUFFICIENCY REQUIREMENTS
SPRING
"""
import pandas as pd
...
# #thermal comfort
# H_Fan = H.Appliance(4,30,1,450,0.2,30)
# H_Fan.windows([480,1140],[0,0],0.35)

H_Air_Conditioner = H.Appliance(1,900,1,380,0.2,15)
H_Air_Conditioner.windows([480,1140],[0,0],0.35)
...
# #Hygiene
# H_shower = H.Appliance(1,H_shower_P,2,50,0.1,3, thermal_P_var = 0.35)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_kny_spring_thermal_mod.csv')