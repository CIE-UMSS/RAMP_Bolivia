...
Household from Kenya with SUFFICIENCY REQUIREMENTS
FALL
"""
import pandas as pd
...
H_Air_Conditioner = H.Appliance(1,900,1,280,0.2,15)
H_Air_Conditioner.windows([600,1020],[0,0],0.35)
# #Nutrition
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_kny_fall_thermal_mod.csv')