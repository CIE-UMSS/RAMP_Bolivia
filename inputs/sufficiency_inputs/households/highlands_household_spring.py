...
#Ilumination
'''
H_indoor_bulb = H.Appliance(4,25,2,350,0.2,10)
H_indoor_bulb.windows([1080,1440],[0,60],0.35)
         
H_outdoor_bulb = H.Appliance(2,30,1,180,0.2,10)
...
H_indoor_bulb = H.Appliance(4,7,2,300,0.2,10)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_HL_spring_hygiene_T2.csv')