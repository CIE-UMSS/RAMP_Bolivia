...
H_indoor_bulb = H.Appliance(4,25,2,270,0.2,10)
...
#thermal comfort
#H_Fan = H.Appliance(1,30,2,300,0.27,30)
#H_Fan.windows([600,1200],[0,0],0.35)z
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_LL_spring_T2.csv')