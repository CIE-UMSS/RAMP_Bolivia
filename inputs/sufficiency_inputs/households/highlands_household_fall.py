...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  6 13:39:04 2024
...
H_indoor_bulb = H.Appliance(4,25,2,400,0.2,10)
H_indoor_bulb.windows([1080,1440],[1080,1440],0.35,[0,60])
...
#thermal comfort
#H_Fan = H.Appliance(1,30,2,300,0.27,30)
#H_Fan.windows([600,1200],[0,0],0.35)
'''
#Nutrition
...
#Hygiene
H_shower = H.Appliance(1,H_shower_P,2,15,0.1,3, thermal_P_var = 0.2)
H_shower.windows([360,540],[1080,1260],0.2) #Use thermal series from lowlands
...
if __name__ == "__main__":
    ...
    uc = UseCase(
        ...
        date_start="2020-04-01", date_end="2020-06-30"
    )
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'HH_HL_fall_shelter_T2.csv')