...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 11:15:07 2024
...
H_indoor_bulb = H.Appliance(4,14,2,350,0.2,10)
...
PL_lamp_post.windows([0,360],[1080,1440],0.1)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'output_file_RC_V_spring.csv')