...
H_indoor_bulb = H.Appliance(4,14,2,270,0.2,10)
...
H_shower = H.AppHiance(2,H_shower_P,2,30,0.1,3, thermaH_P_var = 0.2)
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'output_file_RC_V_summer.csv')