...
HP_Freezer = HP.Appliance(1, 200, 1, 1440, 0, 30, "yes", 3)
HP_Freezer.windows([0, 1440], [0, 0])
HP_Freezer.specific_cycle_1(200, 20, 5, 10) #intensivo
HP_Freezer.specific_cycle_2(200, 15, 5, 15) #intemedio
HP_Freezer.specific_cycle_3(200, 10, 5, 20) #standard
...
if __name__ == "__main__":
    ...
    pp.export_series(Profiles_series, j=None, fname= None, ofname= 'health_post_lowlands.csv')
