# -*- coding: utf-8 -*-
"""
Created on Mon Aug 16 21:33:44 2021

@author: Clau
"""

'''
Dairy farming community - Warm months (sept - apr)
'''
...
LMI_Freezer.cycle_behaviour([360,1199],[0,0],[0,359],[1200,1440])
...
OF_Phone_charger = OF.Appliance(OF,5,2,2,180,0.3,5)
OF_Phone_charger.windows([480,780],[0,0],0.35)

OF_PC = OF.Appliance(OF,1,50,2,210,0.3,10)
OF_PC.windows([480,780],[0,0],0.35)

OF_Printer = OF.Appliance(OF,1,20,2,30,0.3,5)
