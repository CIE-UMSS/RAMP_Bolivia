...
ICT_Phone_charger = ICT.Appliance(5,5,2,300,0.2,5)
ICT_Phone_charger.windows([480,720],[900,1440],0.35)

ICT_TV = ICT.Appliance(2,60,2,360,0.1,30)
ICT_TV.windows([480,720],[780,1020],0.2)

ICT_radio = ICT.Appliance(2,35,2,360,0.2,60)
ICT_radio.windows([480,720],[780,1020],0.35)

ICT_PC = ICT.Appliance(2,150,2,300,0.1,10)
ICT_PC.windows([480,720],[1050,1440],0.35)

ICT_printer = ICT.Appliance(2,100,1,60,0.3,10)
